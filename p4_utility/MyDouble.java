 ...
 * 
 * @author Fawzi Emad & Jan Plane & Ben Bederson & Evan Golub (changed equals)
 */
public class MyDouble {	
	 ...
	 * THE toString METHOD OF THE Polynomial CLASS!!
	 * 
	 * Returns a String representation of the current object.
	 * If the fractional part of the string is 0, then it is converted in integer format.
	 * E.g., the number 23.7 is converted to the string "23.7",
	 * but the number 23.0 is converted to the string "23.0"
	 */
